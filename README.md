...
| 序号 | 姓    名 | 学     号 | 主要工作 | 贡献比 |
|------|------|------|:---------|--------|
| 1 | 高凤武 | 2310233130 | 负责后端API接口开发，设计整体架构与数据库模型，实现RESTful接口规范，对接前端数据交互，管理Git版本控制与代码合并 | 25% |
| 2 | 田嘉浩 | 2310233140 | 编写全局样式与页面独立CSS文件，设计Pinia状态管理方案，实现用户、商品、订单状态管理 | 20% |
| 3 | 钱松林 | 2310233137 | 开发所有页面视图（首页、商品列表、详情页、发布页、订单页、个人中心），实现页面路由与交互逻辑 | 25% |
| 4 | 靳佳 | 2310233124 | 制作项目汇报PPT，撰写技术文档与README，整理答辩演示数据与问题应对预案 | 15% |
| 5 | 石子旋 | 2310233136 | 封装可复用组件（商品卡片、商品表单、页面布局、侧边栏等），确保组件通用性与可维护性 | 15% |
